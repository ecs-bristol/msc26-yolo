# -*- coding: utf-8 -*-
"""
YOLO11-S - Real-time Fire/Smoke Camera Benchmark
...
Example:
    python run_yolo11.py --source 0 --device 0 --conf 0.15 --duration 60 --test-id fire01
"""
...
DEFAULT_MODEL = r"models/yolo11s_best.pt"
