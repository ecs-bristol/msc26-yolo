# -*- coding: utf-8 -*-
"""YOLO26-S Jetson Orin Nano fire/smoke camera benchmark."""
...
MODEL_LABEL = "YOLO26-S"
DEFAULT_MODEL = "models/yolo26s_best.pt"
...
def main():
    ...
    ap.add_argument('--conf',type=float,default=.15)
    ...
    ap.add_argument('--results-root',default='results_camera')
