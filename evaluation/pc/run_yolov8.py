# -*- coding: utf-8 -*-
"""
YOLOv8-S - Real-time Fire/Smoke Camera Benchmark
...
Example:
    python run_yolov8.py --source 0 --device 0 --conf 0.15 --duration 60 --test-id fire01
"""
...
DEFAULT_MODEL = r"models/yolov8s_best.pt"
