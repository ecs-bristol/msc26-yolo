# -*- coding: utf-8 -*-
"""
YOLO26-S - Real-time Fire/Smoke Camera Benchmark
...
Example:
    python run_yolo26.py --source 0 --device 0 --conf 0.15 --duration 60 --test-id fire01
"""
...
DEFAULT_MODEL = r"models/yolo26s_best.pt"
